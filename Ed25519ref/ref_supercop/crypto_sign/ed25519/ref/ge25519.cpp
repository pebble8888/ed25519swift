...
static void choose_t(ge25519_aff *t, unsigned long long pos, signed char b)
{
  ...
  *t = ge25519_base_multiples_affine[5*pos+0];
  cmov_aff(t, &ge25519_base_multiples_affine[5*pos+1],equal_i8(b,1) | equal_i8(b,-1));
  cmov_aff(t, &ge25519_base_multiples_affine[5*pos+2],equal_i8(b,2) | equal_i8(b,-2));
  cmov_aff(t, &ge25519_base_multiples_affine[5*pos+3],equal_i8(b,3) | equal_i8(b,-3));
  cmov_aff(t, &ge25519_base_multiples_affine[5*pos+4],equal_i8(b,-4));
  fe25519_neg(&v, &t->x);
