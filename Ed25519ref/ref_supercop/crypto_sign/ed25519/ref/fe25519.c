...
crypto_uint32 equal_u32(crypto_uint32 a,crypto_uint32 b) /* 16-bit inputs */
{
...
crypto_uint32 ge_u32(crypto_uint32 a,crypto_uint32 b) /* 16-bit inputs */
{
  unsigned int x = a;
...
{
  int i;
  crypto_uint32 m = equal_u32(r->v[31],127);
  for(i=30;i>0;i--)
    m &= equal_u32(r->v[i],255);
  m &= ge_u32(r->v[0],237);
